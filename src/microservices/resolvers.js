...
export default async function res(){
	...
	dns.lookup(`${url_L}`, options, function(err, address, family){
		...
		dns.lookup(`${url_M}`, options, function(err, address2, family){
			UM = address2;
			dns.lookup(`${url_P}`, options, function(err, address3, family){
				UP = address3;
				dns.lookup(`${url_T}`, options, function(err, address4, family){
					UT = address4;
					dns.lookup(`${url_U}`, options, function(err, address5, family){
						UU = address5;
						dns.lookup(`${url_S}`, options, function(err, address6, family){
							US = address6;
